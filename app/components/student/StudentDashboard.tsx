          ...
          <div className="flex flex-col gap-1.5">
            ...
            {latestCommit && (
              <div className="flex items-center gap-3 px-3 py-2.5 rounded-lg" style={{ background: "#1e1e1e" }}>
                ...
                <div className="flex-1"><div className="text-sm text-body">Closing commit saved{latestCommit.specialist ? ` with ${latestCommit.specialist}` : ""}</div><div className="text-[10px] text-faint mt-0.5">{new Date(latestCommit.created_at).toLocaleDateString("en-US", { month: "short", day: "numeric", hour: "numeric", minute: "2-digit" })}</div></div>
              </div>
            )}
