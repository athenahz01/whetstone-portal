  ...
  return (
    <div className="min-h-screen bg-bg flex flex-col items-center justify-center">
      <div className="text-center mb-12">
        <div className="w-12 h-12 rounded-xl flex items-center justify-center mx-auto mb-5 text-2xl font-bold" style={{ background: "#ebebeb", color: "#111" }}>
          W
        </div>
      ...
      <div className="flex gap-4">
        {[
          ...
          <button
            ...
            className="w-70 p-8 bg-white border border-line rounded-xl cursor-pointer text-left hover:border-accent transition-colors"
          >
